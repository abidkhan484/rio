...
"""
    ...
    def _build_component(self, component: rio.Component):
    ...
    def _refresh_sync(
        ...
        properties_to_serialize = IdentityDefaultDict[object, set[str]](set)
    ...
    def _reconcile_tree(
        ...
        assert old_build_data.build_result is not None
